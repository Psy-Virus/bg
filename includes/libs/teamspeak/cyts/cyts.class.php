...
/**
  ...
  * @return		boolean success
  */
    public function slogin($sUser, $sPass)
    {
...
/**
  ...
  * @return		boolean success
  */
    public function wi_login($wiPort=14534, $sTimeout=3)
    {
        if ($this->isSAdmin) {
            $this->wiCookie = false;
            $this->wiPort   = $wiPort;
...
/**
  ...
  * @return		boolean success
  */
    public function wi_select($sID=NULL)
    {
        if (!$this->wiPort) {
            return false;
        }
...
/**
  ...
  */
    public function fastcall($sCall)
    {
...
/**
  ...
  * @return		string Server reply
  */
    public function extendcall($sCall)
    {
...
/**
  ...
  * @return		string reply
  */
    public function debug_lastreply()
    {
...
/**
  ...
  */
    public function info_playerList()
    {
...
/**
  ...
  */
    public function info_playerNameList()
    {
...
/**
  ...
  */
    public function info_channelList()
    {
...
/**
  ...
  */
    public function info_channelNameList()
    {
...
/**
  ...
  */
    public function info_getPlayerByName($pName)
    {
...
/**
  ...
  */
    public function info_getChannelByName($cName)
    {
        if (!$cList = $this->info_channelList()) {
            return -1;
        }
...
/**
  ...
  */
    public function info_channelInfo($cID)
    {
        if (!$cList = $this->info_channelList()) {
            return false;
        }
...
/**
  ...
  */
    public function info_playerInfo($pID)
    {
        if (!$pList = $this->info_playerList()) {
            return false;
        }
...
/**
  ...
  */
    public function info_playerImage($pID)
    {
        if (!$pList = $this->info_playerList()) {
            return false;
        }
...
/**
  ...
  */
    public function info_getCodec($cID)
    {
        $codec = array();
        $codec[] = "CELP 5.1 Kbit";
        $codec[] = "CELP 6.3 Kbit";
...
/**
  ...
  */
    public function info_serverList()
    {
...
/**
  ...
  * @return		array server list, false at failure
  */
    public function info_extendServerList()
    {
...
/**
  ...
  * @return     array serverinformation
  */
    public function info_globalInfo()
    {
...
/**
  ...
  */
    public function info_defaultChannel()
    {
        if (!$cList = $this->info_channelList()) {
            return false;
        }
...
/**
  ...
  */
    public function info_channelUser($cID)
    {
        if (!$pList = $this->info_playerList()) {
            return false;
        }
...
/**
  ...
  */
    public function info_translateFlag($vFlag, $fType = 1, $oStr = false)
    {
...
/**
  ...
  */
    public function admin_kickFromChannel($pID)
    {
...
/**
  ...
  * @return     boolean True at success, False at failure
  */
    public function admin_kick($pID, $reason="")
    {
...
/**
  ...
  * @return     boolean True at success, False at failure
  */
    public function admin_remove($pID)
    {
...
/**
  ...
  * @return     boolean True at success, False at failure
  */
    public function admin_move($pID, $cID)
    {
        return ($this->_extendcall("MPTC $cID $pID") == CYTS_OK);
    }
...
/**
  ...
  * @return		boolean success
  */
    public function admin_clearChannel($cID, $kMode = 1, $param = NULL)
    {
...
/**
  ...
  */
    public function admin_kickIdler($tIdle, $tFlag, $kMode = 1, $param = NULL)
    {
        if (!$uList = $this->info_playerList()) {
            return false;
        }
...
/**
  ...
  */
    public function admin_dbUserList()
    {
...
/**
  ...
  */
    public function admin_getDBUserByName($uName)
    {
...
/**
  ...
  */
    public function admin_getDBUserData($uID)
    {
        if (!$uRead = $this->admin_dbUserList()) {
            return false;
        }
...
/**
  ...
  * @return     boolean success
  */
    public function admin_dbUserAdd($lName, $lPass, $lSA = false)
    {
        $lSA = ($lSA) ? 1 : 0;
...
/**
  ...
  * @return     boolean success
  */
    public function admin_dbUserDel($uID)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function admin_dbUserChangePW($uID, $uPW)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function admin_dbUserChangeSA($uID, $uSA = false)
    {
        $uSA = ($uSA) ? 1 : 0;
...
/**
  ...
  * @return     array user list
  */
    public function sadmin_dbSUserList()
    {
...
/**
  ...
  * @return     integer UserID, -1 at failure
  */
    public function sadmin_getDBSUserByName($uName)
    {
...
/**
  ...
  * @return     array user data, false at failure
  */
    public function sadmin_getDBSUserData($uID)
    {
        if (!$uRead = $this->sadmin_dbSUserList()) {
            return false;
        }
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_dbSUserAdd($lName, $lPass)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_dbSUserDel($uID)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_dbSUserChangePW($uID, $uPW)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_messageServer($sMsg, $uHide = false)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_messageUser($uID, $sMsg, $uHide = false)
    {
        $sMsg = ($uHide) ? "@".$sMsg : $sMsg;
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_messageAll($sMsg, $uHide = false)
    {
        $sMsg = ($uHide) ? "@".$sMsg : $sMsg;
...
/**
  ...
  */
    public function sadmin_findChannel($sQuery)
    {
...
/**
  ...
  * @return     array search matches
  */
    public function sadmin_findPlayer($sQuery)
    {
...
/**
  ...
  */
    public function sadmin_channelInfo($cID)
    {
...
/**
  ...
  * @return     array channel information
  */
    public function sadmin_playerInfo($cID)
    {
...
/**
  ...
  * @return     array channel information
  */
    public function sadmin_dbChannelInfo($cID)
    {
...
/**
  ...
  * @return     array search matches
  */
    public function sadmin_dbFindPlayer($sQuery)
    {
...
/**
  ...
  */
    public function sadmin_dbServerList()
    {
...
/**
  ...
  * @return     array server list
  */
    public function sadmin_dbServerInfo($sID, $sList=false)
    {
...
/**
  ...
  * @return     boolean status
  */
    public function sadmin_serverStart($sID)
    {
...
/**
  ...
  * @return     boolean status
  */
    public function sadmin_serverStop()
    {
...
/**
  ...
  * @return     boolean status
  */
    public function sadmin_serverDelete($sID)
    {
...
/**
  ...
  * @return     boolean status
  */
    public function sadmin_serverAdd($sUDP)
    {
...
/**
  ...
  * @return     boolean status
  */
    public function sadmin_serverSet($sVar, $sVal)
    {
...
/**
  ...
  */
    public function sadmin_logRead($lNum)
    {
...
/**
  ...
  * @return     array logdata
  */
    public function sadmin_logFind($lQuery)
    {
...
/**
  ...
  * @return     array logdata
  */
    public function sadmin_logWrite($lLine)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_banPlayer($pID, $bTime)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_banIP($pIP, $bTime)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_banDel($bID)
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_banClear()
    {
...
/**
  ...
  */
    public function sadmin_banList()
    {
...
/**
  ...
  * @return     boolean success
  */
    public function sadmin_sppriv($pID, $sPriv, $pVal)
    {
...
/**
  ...
  */
    public function wi_readServerSettings()
    {
...
/**
  ...
  * @return     boolean success
  */
    public function wi_writeServerSettings($sData = array())
    {
...
/**
  ...
  * @return     array server vars
  */
    public function wi_readHostSettings()
    {
...
/**
  ...
  * @return     boolean success
  */
    public function wi_writeHostSettings($sData = array())
    {
        if (!$cData = $this->wi_readServerSettings()) {
            return false;
        }
...
/**
  ...
  */
    public function wi_readGroupPermissions($class)
    {
...
/**
  ...
  * @return		boolean success
  */
    public function wi_writeGroupPermissions($class, $sData = array())
    {
        $class = strtolower($class);
        $classes = array('sa', 'ca', 'op', 'v', 'r', 'u');
        if (!in_array($class, $classes, true)) {
...
/**
  ...
  */
    public function _fastcall($sCall = "")
    {
        if (!is_resource($this->sCon)) {
            return false;
        }
...
/**
  ...
  * @return     string returns the server's return data
  */
    public function _extendcall($sCall = "")
    {
...
/**
  ...
  * @return     string returns the server's return data
  */
    public function _wipost($sFile, $sCall=array(), $sTimeout = 3)
    {
        if (!$this->wiPort) {
            return false;
        }
...
/**
  ...
  * @return     string returns the server's return data
  */
    public function _wiget($sFile, $sTimeout = 3)
    {
        if (!$this->wiPort) {
            return false;
        }
